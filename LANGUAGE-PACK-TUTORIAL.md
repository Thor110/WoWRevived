...
That is, that it gets the entire length of the string after the third space and it relies on there being 1397 lines to the file.
...
If you create a language pack please reach out to me as I would like to include them in this repository for future use.